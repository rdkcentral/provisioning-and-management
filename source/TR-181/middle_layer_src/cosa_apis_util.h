...
struct _COSA_DML_IP_STATS;
void CosaUtilApplyIpIfByteStats64(char * ifname, struct _COSA_DML_IP_STATS * pStats);
void CosaUtilCopyIfStatsToIpStats(PCOSA_DML_IF_STATS pIfStats, struct _COSA_DML_IP_STATS * pIpStats);
